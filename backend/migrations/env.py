...
config.set_section_option(section, "POSTGRES_NAME", env.POSTGRES_NAME)
config.set_section_option(section, "POSTGRES_USER", env.POSTGRES_USER)
config.set_section_option(section, "POSTGRES_PASS", env.POSTGRES_PASS)
...
def get_url() -> str:
    settings = Settings()
    return str(settings.generate_postgres_url())
